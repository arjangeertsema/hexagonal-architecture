...
public class AnswerRejectedEvent : VersionedDomainEvent<AnswerQuestionId>, IUserTaskId
{
    public AnswerRejectedEvent(AnswerQuestionId aggregateId, string userTaskId, string rejection, string rejectedBy, DateTime rejected)
        : base(aggregateId)
